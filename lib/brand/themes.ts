...
const BASE_TYPE: Record<TypeRole, TypeStyle> = {
  ...
  metricXl: { size: 340, tracking: 0, weight: 600, lineHeight: 0.84, family: 'display' },
  metricLarge: { size: 240, tracking: 0, weight: 600, lineHeight: 0.86, family: 'display' },
...
export const THEMES: Record<BrandId, BrandTheme> = {
  ...
  vigo: {
    ...
    type: typeFor({
      ...
      metricXl: { size: 310, weight: 400, lineHeight: 0.88 },
      metricLarge: { size: 220, weight: 400, lineHeight: 0.9 },
  ...
  alessi: {
    ...
    type: typeFor({
      ...
      metricXl: { size: 320, weight: 700 },
      metricLarge: { size: 228, weight: 700 },
    }),
