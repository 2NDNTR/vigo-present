...
const LOGO = (): Block => ({ id: uid('b'), type: 'logo', variant: 'primary' });
...
const templates: PageTemplate[] = [
  /* ============================== INTRO ============================== */
  {
    ...
    layout: lay('1fr', '1fr auto', ['top', 'main'], 110, 28),
  ...
  /* =============================== CLOSING =========================== */
  {
    ...
    layout: lay('1fr', 'auto 1fr', ['head', 'main'], 130, 44),
    slots: [
      { key: 'head', label: 'Heading', accepts: TEXT_TYPES, max: 2, hint: 'Heading', justify: 'start', maxWidth: 1100 },
  ...
  },
  {
    ...
    layout: lay('1fr 1fr', '1fr', ['main side'], 130, 80),
    background: { kind: 'color', color: 'brandPrimary', overlay: 'none' },
    slots: [
