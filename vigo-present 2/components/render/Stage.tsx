    ...
    >
        ...
        >
          ...
          {page.showLogo ? (
            <div className="page-chrome-logo">
              <BlockView block={{ id: page.id + '-lg', type: 'logo', variant: 'primary' }} ctx={{ theme }} />
            </div>
          ) : null}
        </div>
      ) : null}
      ...
      <div
        ...
        style={{
          ...
          padding: `calc(var(--u) * ${template.layout.pad}px)`,
          paddingTop: chromeOn ? `calc(var(--u) * ${chromePad + CHROME_H}px)` : undefined,
